...
<body class="g-sidenav-show">
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-white btn bg-gradient-light mt-4 w-80" href=" {{ 'secretaire_index' }} ">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center ">
                            <i class="material-icons opacity-10 ">dashboard</i>
                        </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3 ">
                <nav aria-label="breadcrumb ">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5 ">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active " aria-current="page ">Secrétaire/Accueil</li>
                    </ol>
                    <a href=" {{'secretaire_index'}} ">
        ...
        <h3 class="ms-5">Bienvenue chère Secrétaire</h3>
                    ...
                    <div class="input-group-btn w-100 h-100  col-md-4">
                        <a href="{{ route('etudiants.create') }} ">
                            <button type="button" class="btn btn-light w-50 h-100">
                                ...
                                <p>
                                <h4 class="text-dark font-bold">Ajouté un étudiant</h4>
                                </p>
                            </button>
                        </a>
                    </div>
                        ...
                        <a href="{{ route('etudiants.index') }}">
                            <button type="button" class="btn btn-light w-50 h-100">
                                <span class="badge badge-light  "> <img src="../assets/img/Graduation Cap_80px.png"
                                        style="width:150px; height:180px" alt=""></span>
                                <p>
                                <h4 class="text-dark font-bold">Liste des étudiants</h4>
                                </p>
                            </button>
                        </a>
                    </div>
